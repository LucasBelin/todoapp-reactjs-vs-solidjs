...
function ProgressBar({ progressPercent, progressBarPos, accent }) {
  return (
    <div>
      ...
      <div
        style={{ backgroundColor: accent, left: progressBarPos, clipPath: "polygon(50% 0, 100% 100%, 0 100%)" }}
        className="h-2 w-1.5 bg-red-500 absolute transform -translate-y-2.4 rotate-180 transition-all"
      ></div>
    </div>
  )
}
